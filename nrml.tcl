...
$ns at 1.0 "$node(1) setdest 750.0 12.0 30.0"
$ns at 1.0 "$node(2) setdest 25.0 1.0 30.0"

$ns at 1.0 "$node(3) setdest 850.0 40.0 30.0"
$ns at 1.0 "$node(4) setdest 185.0 10.0 30.0"

$ns at 1.0 "$node(5) setdest 50.0 50.0 30.0"
$ns at 1.0 "$node(6) setdest 485.0 12.0 30.0"
